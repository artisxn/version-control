...
use codicastudio\Version\Package\Exceptions\MethodNotFound;
use codicastudio\Version\Package\Support\Absorb;
use codicastudio\Version\Package\Support\Config;
use codicastudio\Version\Package\Support\Constants;
use codicastudio\Version\Package\Support\Git;
use codicastudio\Version\Package\Support\Increment;
use codicastudio\Version\Package\Support\Timestamp;
use codicastudio\Yaml\Package\Yaml;

class Version
{
    /**
     * @var \codicastudio\Yaml\Package\Yaml
     */
    protected $yaml;

    /**
     * @var \codicastudio\Version\Package\Support\Config
     */
    protected $config;

    /**
     * @var \codicastudio\Version\Package\Support\Git
     */
    protected $git;

    /**
     * @var \codicastudio\Version\Package\Support\Increment
     */
    protected $increment;
    ...
    protected function instantiate(
        ...
        $yaml = $this->instantiateClass($yaml ?: app('codicastudio.yaml'), 'yaml');
