...
namespace codicastudio\Version\Tests;

use Illuminate\Support\Facades\Artisan;
use Illuminate\Support\Facades\Blade;
use codicastudio\Version\Package\Exceptions\GitTagNotFound;
use codicastudio\Version\Package\Exceptions\MethodNotFound;
use codicastudio\Version\Package\Facade as VersionFacade;
use codicastudio\Version\Package\Support\Constants;
use codicastudio\Version\Package\Version;
use codicastudio\Version\Package\Version as VersionService;
...
class VersionTest extends TestCase
{
    ...
    public function testDirectFromApp()
    {
        $this->assertEquals(
            $this->getFormattedVersion('version %s.%s.%s (commit %s)'),
            app('codicastudio.version')->format('full')
        );
    }
